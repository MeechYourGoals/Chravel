...
function getChatMessages(trip: TripDef): { content: string; offset_hours: number }[] {
  const map: Record<string, { content: string; offset_hours: number }[]> = {
    ...
    'carlton-nola-jazz-2025': [
      { content: 'Landing in NOLA at noon. Going straight to Frenchmen Street. 🎷', offset_hours: -6 },
      { content: 'Beignets at Café du Monde first thing — non-negotiable.', offset_hours: 0 },
      { content: 'The Preservation Hall show was transcendent. Real jazz is alive.', offset_hours: 18 },
      { content: 'Late night po\'boys at Parkway Bakery. Turkey & gravy. Trust me.', offset_hours: 30 },
      { content: 'Swamp tour tomorrow morning — gators and all.', offset_hours: 36 },
      { content: 'NOLA will always be one of my favorite cities. The soul is unmatched.', offset_hours: 60 },
    ],
    'carlton-tokyo-2025': [
      { content: 'Narita Express to Shinjuku — meeting everyone at the hotel lobby at 6pm.', offset_hours: -2 },
      { content: 'Tsukiji outer market for breakfast tomorrow. Fresh sushi at 7am.', offset_hours: 6 },
      { content: 'Found a 6-seat omakase in Ginza with a 3-month waitlist. Got us in. 🍣', offset_hours: 24 },
      { content: 'Shibuya Crossing at night is something else. Filmed the whole thing.', offset_hours: 48 },
      { content: 'Ramen Ichiran at 1am — the solo booth experience is peak introvert dining.', offset_hours: 60 },
      { content: 'TeamLab Borderless was mind-blowing. Allow 3 hours minimum.', offset_hours: 72 },
      { content: 'Day trip to Hakone for hot springs and views of Fuji. Worth every minute.', offset_hours: 120 },
      { content: 'Last night in Roppongi. This trip changed how I think about food and culture.', offset_hours: 180 },
    ],
    'carlton-ibiza-2026': [
      { content: 'Birthday trip is LOCKED. Villa booked, flights confirmed. Let\'s go! 🎉', offset_hours: -168 },
      { content: 'Café del Mar sunset session Friday night — I\'ll put us on the list.', offset_hours: -72 },
      { content: 'Private boat charter on Saturday. Departure from San Antonio marina at 11am.', offset_hours: -24 },
      { content: 'The villa has a pool, DJ setup, and views of Dalt Vila. We\'re set.', offset_hours: 0 },
      { content: 'Birthday dinner at Cala Bonita — reservation for 10 at 8:30pm.', offset_hours: 12 },
      { content: 'Pacha tonight. Table confirmed. This is what 32 looks like. 🕺', offset_hours: 36 },
  ...
  map['carlton-chappelle-chicago'] = [
    { content: 'Load-in at the Chicago Theatre starts at 10am. Crew meet at the loading dock.', offset_hours: -12 },
    { content: 'Soundcheck moved to 4pm — Dave wants extra time for the new material.', offset_hours: 0 },
    { content: 'Greenroom setup: sparkling water, fresh fruit, and NO peanuts. Allergy on crew.', offset_hours: 6 },
    { content: 'Show was INCREDIBLE. Standing ovation. Three encores. Chicago loves Dave.', offset_hours: 24 },
  ...
  map['carlton-nba-media-vegas'] = [
    ...
    { content: 'Interview with the #2 pick scheduled for 3pm at the Thomas & Mack Center.', offset_hours: 0 },
    { content: 'Content team: need B-roll of the crowd energy during the halftime dunk contest.', offset_hours: 12 },
    { content: 'Podcast recording at the hotel suite tonight — mics are set up.', offset_hours: 24 },
    { content: 'Got exclusive quotes from the Celtics coach. This episode is going to be fire 🔥', offset_hours: 36 },
    { content: 'Wrap on the Vegas media trip. Content calendar is loaded for the next month.', offset_hours: 72 },
  ];
  map['carlton-podcast-austin'] = [
    { content: 'Studio is booked at the hotel conference room. Bringing portable mics.', offset_hours: -12 },
    { content: 'Panel on creator monetization at 2pm — I\'m moderating.', offset_hours: 0 },
    { content: 'Live podcast recording tonight with 200+ in attendance. Sold out.', offset_hours: 18 },
    { content: 'Brand partnership meeting with Nike tomorrow at 10am. Big opportunity.', offset_hours: 24 },
    { content: 'Austin\'s creator scene is growing fast. So many talented people here.', offset_hours: 48 },
    { content: 'Summit was a success. 3 new brand deals in the pipeline.', offset_hours: 60 },
  ];
  map['carlton-dj-tour-berlin'] = [
    { content: 'Equipment shipped to Berlin — arriving at the venue Thursday morning.', offset_hours: -48 },
    { content: 'Studio session with local producers at Funkhaus from 2-6pm.', offset_hours: 0 },
    { content: 'Tresor set is Saturday night 1-3am. Going to debut the new tracks.', offset_hours: 12 },
    { content: 'After-party location confirmed. Invite-only. 50 people max.', offset_hours: 24 },
    { content: 'The crowd at Tresor was something else. Berlin knows how to party.', offset_hours: 48 },
    { content: 'Berlin might be my favorite city for music. The culture here is unmatched.', offset_hours: 72 },
  ];
  map['carlton-film-vancouver'] = [
    { content: 'Shot list finalized. Day 1: downtown locations. Day 2: Stanley Park. Day 3: studio.', offset_hours: -24 },
    { content: 'Crew call time is 6am at the Gastown location. Coffee will be there.', offset_hours: 0 },
    ...
    { content: 'Post-production meeting Monday. Editor is already cutting the first assembly.', offset_hours: 96 },
  ];
  map['carlton-fashion-paris'] = [
    { content: 'Schedule: Jacquemus Mon, Louis Vuitton Tue, Dior Wed, Chanel Thu.', offset_hours: -24 },
    { content: 'Backstage pass confirmed for the Louis Vuitton show. Content gold.', offset_hours: 0 },
    { content: 'Shot some incredible looks at the Palais de Tokyo installation.', offset_hours: 24 },
    { content: 'Dinner at Le Cinq tonight — Michelin 3-star. Dress to impress.', offset_hours: 36 },
    { content: 'Paris Fashion Week is exhausting but the content is chef\'s kiss. 📸', offset_hours: 72 },
    { content: 'The croissants alone make this trip worth it.', offset_hours: 96 },
  ];
  map['carlton-sports-agent-miami'] = [
    { content: 'Client meeting at 10am at the Four Seasons. Bring the updated contract terms.', offset_hours: 0 },
    { content: 'Dinner at Prime 112 tonight — client wants to celebrate the deal.', offset_hours: 8 },
    { content: 'Heat game tomorrow night. Kaseya Center, Section 108, Row 2.', offset_hours: 18 },
    { content: 'Deal is signed. Three-year extension. Huge win for the team. 🤝', offset_hours: 36 },
  ...
  map['carlton-music-fest-la'] = [
    { content: 'Stage plot approved. Main stage, secondary stage, and acoustic tent.', offset_hours: -48 },
    ...
    { content: 'Headliner just killed it. The crowd was electric. Best set of the festival.', offset_hours: 26 },
    { content: 'Festival wrap. Zero incidents, great weather, incredible performances. We did it.', offset_hours: 48 },
  ];
  map['carlton-founder-tahoe'] = [
    { content: 'Agenda: Day 1 = pitch sessions. Day 2 = fireside chats. Day 3 = outdoor activities.', offset_hours: -24 },
    { content: 'Met a VC from a16z at the welcome dinner. Very interested in the creator space.', offset_hours: 6 },
    { content: 'Morning kayaking on the lake before sessions start. This view is unreal.', offset_hours: 18 },
    { content: 'Great feedback on my pitch. Need to refine the go-to-market slide.', offset_hours: 30 },
    { content: 'Connected with 12 founders in similar spaces. The network here is incredible.', offset_hours: 54 },
    { content: 'Lake Tahoe retreat is the best founder event I\'ve attended. Already signed up for next year.', offset_hours: 72 },
  ];
  map['carlton-creator-conf-nyc'] = [
    { content: 'Keynote is Tuesday at 10am. Slides are done. Rehearsal at 8am.', offset_hours: -12 },
    { content: 'Panel on "Building a Creator Business" at 2pm — I\'m alongside MrBeast\'s team.', offset_hours: 0 },
    { content: 'After-party at The Standard rooftop. Views of the High Line at sunset.', offset_hours: 12 },
    ...
    { content: 'NYC energy is unmatched. This conference gets better every year.', offset_hours: 48 },
  ];

  // Event trips
  map['carlton-event-miami-f1'] = [
    { content: 'VIP paddock wristbands distributed. Don\'t lose them — they\'re $5K each.', offset_hours: -24 },
    ...
    { content: 'Post-race concert by The Weeknd. This event is on another level.', offset_hours: 54 },
    { content: 'Best F1 weekend yet. Miami knows how to put on a show.', offset_hours: 72 },
  ];
  map['carlton-event-super-bowl'] = [
    { content: 'Tailgate setup starts at 10am. Bringing the grill and the good speakers.', offset_hours: -6 },
    { content: 'Pre-game concert is Usher again? Apparently it\'s a different artist this year.', offset_hours: 0 },
    ...
    { content: 'Super Bowl in NOLA is the perfect combination. Football + best food city.', offset_hours: 24 },
  ];
  map['carlton-event-cannes'] = [
    { content: 'Red carpet premiere tonight at 7pm. Black tie mandatory.', offset_hours: 0 },
    { content: 'Yacht party invitation from the producers — dock at Port Canto, 9pm.', offset_hours: 12 },
    { content: 'Screening of the new Nolan film. Speechless. Oscar contender for sure.', offset_hours: 24 },
    { content: 'Lunch at La Colombe d\'Or. The art collection on the walls is priceless — literally.', offset_hours: 48 },
    { content: 'Networking dinner with distributors. Four deal discussions in one evening.', offset_hours: 72 },
    { content: 'Cannes is where art meets business. There\'s nothing else like it.', offset_hours: 120 },
  ];
  map['carlton-event-jfl-montreal'] = [
    ...
    { content: 'Old Montreal food tour today. Poutine, smoked meat, and maple everything.', offset_hours: 36 },
    { content: 'The new comedians this year are INCREDIBLE. Watch for that Brooklyn kid.', offset_hours: 48 },
    { content: 'Comedy is the best live art form. These shows prove it every year.', offset_hours: 96 },
  ...
  map['carlton-event-art-basel'] = [
    ...
    { content: 'Collector dinner in the Design District tonight. Seated next to the curator from MoMA.', offset_hours: 18 },
    { content: 'Bought a piece from an emerging artist. Supporting new talent is the move.', offset_hours: 36 },
    { content: 'Art Basel is where you see what culture will look like in 5 years.', offset_hours: 72 },
    { content: 'Miami in December > Miami in August. Perfect weather for art walks.', offset_hours: 84 },
  ];
  map['carlton-event-sundance'] = [
    { content: 'Premiere tickets for 3 films secured. First screening at 10am tomorrow.', offset_hours: -12 },
    { content: 'The documentary about AI art just won the audience award. Mind-blowing.', offset_hours: 24 },
    { content: 'Après-ski at Deer Valley with the cast of the opening night film. Surreal.', offset_hours: 36 },
    { content: 'Park City is magical in winter. The snow, the movies, the hot chocolate.', offset_hours: 48 },
    { content: 'Discovered 4 films I\'ll be watching for at the Oscars.', offset_hours: 96 },
    { content: 'Sundance reminds me why I love storytelling. See you next January.', offset_hours: 120 },
  ];
  map['carlton-event-sxsw'] = [
    { content: 'Interactive badge confirmed. Keynote schedule is stacked this year.', offset_hours: -24 },
    { content: 'The AI + Music panel was the best session so far. Wild implications.', offset_hours: 24 },
    { content: 'Last year\'s SXSW was good but this year is on another level.', offset_hours: 48 },
    { content: 'Secret show at Mohawk tonight — indie band from London. Trust me.', offset_hours: 72 },
    { content: 'Austin keeps growing but 6th Street still hits different during SXSW.', offset_hours: 120 },
    { content: 'Wrapped SXSW 2026. Already counting down to next year.', offset_hours: 192 },
  ];
  map['carlton-event-monaco-gp'] = [
    { content: 'Yacht viewing confirmed. Deck access at Turn 1 — the best angle on the circuit.', offset_hours: -24 },
    { content: 'Casino Square at night is pure James Bond energy.', offset_hours: 0 },
    { content: 'Practice laps echoing through the streets. The sound is visceral.', offset_hours: 12 },
    { content: 'Dinner at Le Louis XV tonight. Alain Ducasse\'s 3-Michelin-star masterpiece.', offset_hours: 24 },
    { content: 'Race day. The most iconic circuit in motorsport. Champagne on the yacht.', offset_hours: 48 },
  ...
  return map[trip.id] || [
    ...
    { content: 'Logistics are coming together nicely. All details in the calendar.', offset_hours: 0 },
    { content: 'Having an amazing time. This trip is one for the books.', offset_hours: 24 },
    { content: 'Can\'t believe it\'s almost over. Time flies when you\'re living your best life.', offset_hours: 48 },
...
function getPoll(trip: TripDef): { question: string; options: string[] } | null {
  const polls: Record<string, { question: string; options: string[] }> = {
    ...
    'carlton-event-cannes': { question: 'Yacht party or rooftop party?', options: ['Yacht at Port Canto', 'Rooftop at Martinez', 'Why not both'] },
  };
...
serve(async (req) => {
  ...
  try {
    ...
    for (const table of ['trip_chat_messages', 'trip_events', 'trip_tasks', 'trip_payment_messages', 'trip_polls', 'trip_links', 'ai_queries']) {
    ...
    for (const trip of ALL_TRIPS) {
      ...
      for (let i = 0; i < queries.length; i++) {
        aiRows.push({
          ...
          metadata: JSON.stringify({ model: 'gemini-2.0-flash', context_sources: ['chat', 'calendar', 'places'] }),
        });
      }
    }
