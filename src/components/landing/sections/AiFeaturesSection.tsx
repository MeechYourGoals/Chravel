...
export const AiFeaturesSection = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 md:py-0 flex flex-col items-center justify-start md:justify-center min-h-0 md:min-h-screen space-y-8 md:space-y-12">
