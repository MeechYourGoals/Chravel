        ...
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground/90 mb-4">
              Welcome to Chravel ("we," "our," or "us"). We respect your privacy and are committed to protecting your personal data. This privacy policy explains how we collect, use, disclose, and safeguard your information when you use our platform.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2 text-foreground/90">
              <li><strong>With Trip Members:</strong> Information you share within a trip is visible to other trip members</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground/90 mb-4">You have the following rights regarding your personal information:</p>
            <ul className="list-disc pl-6 mb-4 space-y-2 text-foreground/90">
          ...
          <section className="mb-8">
            ...
            <ul className="list-none space-y-2 text-foreground/90">
              <li><strong>Email:</strong> privacy@chravel.com</li>
              <li><strong>Mail:</strong> Chravel Privacy Team, [Company Address]</li>
            </ul>
          </section>
        </div>
      </div>
