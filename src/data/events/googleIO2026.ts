...
export const googleIO2026Event: EventData = {
  ...
  description:
    "Spotify's annual holiday celebration in Seoul bringing together artists, creators, industry leaders, and tastemakers. Featuring live performances, DJ sets, immersive brand activations, and curated experiences.",
  ...
  itinerary: [
    {
      ...
      events: [
        {
          title: 'VIP Check-In & Welcome Cocktails',
          location: 'Spotify House Seoul',
          time: '19:00',
        },
  ...
  sessions: [
    {
      ...
      description:
        "Spotify's immersive brand experience featuring live performances, artist collaborations, and exclusive music previews.",
      speaker: 'dj-soda',
      track: 'main-stage',
      startTime: '20:00',
      endTime: '22:00',
    ...
    },
    {
      ...
      description:
        'Exclusive live set from Jay Park featuring unreleased tracks and surprise guest collaborations.',
      speaker: 'jay-park',
      track: 'main-stage',
      startTime: '21:00',
      endTime: '21:45',
  ...
  agenda: [
    ...
    {
      id: 'sps-a4',
      title: 'DJ Sets & Late Night Party',
      start_time: '22:00',
      end_time: '03:00',
      location: 'Club Level',
    },
  ...
  tasks: [
    ...
    {
      id: 'sps-t4',
      title: 'Tag @spotify in your social posts for featured content',
      sort_order: 3,
    },
  ],
};
