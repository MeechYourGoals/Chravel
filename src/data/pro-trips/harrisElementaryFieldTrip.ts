...
export const harrisElementaryFieldTrip: ProTripData = {
  ...
  description:
    'Educational field trip to Washington DC for 8th grade students from Harris Elementary.',
  ...
  participants: [
    ...
    { id: '17', name: 'Mr. David Chen', avatar: getMockAvatar('Mr. David Chen'), role: 'Teachers' },
    {
      ...
      avatar: getMockAvatar('Student Group A'),
      role: 'Students',
    },
    {
      id: '19',
      name: 'Student Group B',
      avatar: getMockAvatar('Student Group B'),
      role: 'Students',
    },
  ],
  budget: {
  ...
  itinerary: [
    {
      ...
      events: [
        ...
        {
          time: '12:00',
          title: 'Arrival in Washington DC',
