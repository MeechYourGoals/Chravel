...
export const TripChat = ({
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Unified Chat Shell - Glassmorphic container matching Trip Collaborators design */}
      <div className="max-w-5xl mx-auto p-6 overflow-hidden flex flex-col flex-1 bg-white/10 backdrop-blur-md rounded-3xl border border-white/20">
