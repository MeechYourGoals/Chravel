/**
 * Shared voice function declarations for Gemini Live API.
 *
 * Single source of truth consumed by both gemini-voice-proxy and
 * gemini-voice-session so tool schemas never diverge.
 *
 * Uses lowercase OpenAPI types per Vertex AI Live API specification.
 */
  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        artifact_types: { type: 'array', items: { type: 'string' }, description: 'Filter by type' },
