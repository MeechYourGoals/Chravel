  ...
  return (
    <div className="flex flex-col items-center justify-start px-4 pt-16 pb-16 md:pt-4 md:pb-20">
      ...
      <div className="max-w-5xl mx-auto space-y-4 animate-fade-in">
        {/* Headline - Centered */}
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent leading-tight text-center">
          Plan Together.<br />Travel Better.
        </h1>

        {/* Subheadline */}
        <p className="text-base sm:text-lg md:text-xl text-foreground max-w-2xl mx-auto text-center break-words">
        ...
        {/* Trust Badge */}
        <p className="text-xs sm:text-sm md:text-base text-foreground pt-6 text-center">
