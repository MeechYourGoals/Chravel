  ...
  const mockCampaigns: CampaignWithTargeting[] = [
    {
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1540541338287-41700207dee6?w=800', alt: 'Paradise Resort Beach', order: 0 },
        { url: 'https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=800', alt: 'Resort Pool View', order: 1 }
      ],
      destination_info: {
        location: 'Maldives',
        city: 'Male',
    ...
    },
    {
      ...
      images: [
        ...
        { url: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800', alt: 'Costa Rica Landscape', order: 1 }
      ],
      destination_info: {
        location: 'Costa Rica',
        city: 'San Jose',
