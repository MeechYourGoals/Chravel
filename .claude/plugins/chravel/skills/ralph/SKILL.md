---
name: ralph
description: Use when converting a PRD markdown document to Ralph's prd.json format for autonomous execution. Triggers on "convert PRD to ralph", "set up ralph", "prepare for ralph", "create prd.json from PRD".
---
