  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="media-grid-item rounded-md bg-white/5 relative block w-full aspect-square overflow-hidden"
        style={{
      ...
      >
        <TripMediaRenderer
          ...
          alt="Trip media"
          // We handle click in the button wrapper, but pass empty onClick to prevent double firing or allow TripMediaRenderer to be passive
          onClick={() => {}} 
        />
      </button>
    </div>
