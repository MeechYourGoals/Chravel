export const mockPolls = [
  // Trip 1: Spring Break Cancun 2026
  {
    ...
    options: [
      { id: 'opt-1', text: 'Sushi Place', voteCount: 3, voters: ['user-1', 'user-2', 'user-3'] },
      {
        ...
        text: 'Taco Stand',
        voteCount: 5,
        voters: ['user-4', 'user-5', 'user-6', 'user-7', 'user-8'],
      },
  ...
  },
  {
    ...
    options: [
      { id: 'opt-1', text: '10 AM', voteCount: 3, voters: ['user-1', 'user-2', 'user-3'] },
      {
        ...
        text: '11 AM',
        voteCount: 4,
        voters: ['user-4', 'user-5', 'user-6', 'user-7'],
      },
    ...
    options: [
      {
        ...
        voteCount: 8,
        voters: ['user-1', 'user-2', 'user-3', 'user-4', 'user-5', 'user-6', 'user-7', 'user-8'],
      },
      {
        id: 'opt-2',
        text: 'Ramen Shop',
        voteCount: 5,
        voters: ['user-9', 'user-10', 'user-11', 'user-12', 'user-13'],
      },
  ...
  },
  {
    ...
    options: [
      {
        id: 'opt-1',
        text: '8:00 AM - Early start',
        voteCount: 6,
        voters: ['user-1', 'user-2', 'user-3', 'user-4', 'user-5', 'user-6'],
      },
      {
        id: 'opt-2',
        text: '10:00 AM - Mid-morning',
        voteCount: 9,
        voters: [
          'user-7',
          'user-8',
  ...
  // Trip 3: The Tyler's Tie The Knot
  {
    ...
    options: [
      ...
      },
      {
        ...
        text: 'Seafood Grill',
        voteCount: 5,
        voters: ['user-21', 'user-22', 'user-23', 'user-24', 'user-25'],
      },
    ],
    status: 'active' as const,
    total_votes: 25,
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        text: '2:00 PM',
        voteCount: 4,
        voters: ['user-22', 'user-23', 'user-24', 'user-25'],
      },
    ],
    status: 'active' as const,
    total_votes: 25,
  ...
  // Trip 4: Kristen's Bachelorette Party
  {
    ...
    options: [
      {
        id: 'opt-1',
        text: "Tootsie's Orchid Lounge",
        voteCount: 4,
        voters: ['user-1', 'user-2', 'user-3', 'user-4'],
      },
      {
        id: 'opt-2',
        text: "Robert's Western World",
        voteCount: 8,
        voters: ['user-5', 'user-6', 'user-7', 'user-8', 'user-9', 'user-10', 'user-11', 'user-12'],
      },
      {
        id: 'opt-3',
        text: 'The Stage on Broadway',
        voteCount: 3,
        voters: ['user-13', 'user-14', 'user-15'],
      },
    ],
    status: 'active' as const,
    total_votes: 15,
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        text: '11:30 AM',
        voteCount: 7,
        voters: ['user-6', 'user-7', 'user-8', 'user-9', 'user-10', 'user-11', 'user-12'],
      },
  ...
  // Trip 5: Coachella Squad 2026
  {
    ...
    options: [
      ...
      },
      {
        ...
        text: 'Sahara Tent DJ',
        voteCount: 6,
        voters: ['user-11', 'user-12', 'user-13', 'user-14', 'user-15', 'user-16'],
      },
      {
        id: 'opt-3',
        text: 'Outdoor Stage Artist',
        voteCount: 4,
        voters: ['user-17', 'user-18', 'user-19', 'user-20'],
      },
    ],
    status: 'active' as const,
    total_votes: 20,
  ...
  },
  {
    ...
    options: [
      {
        id: 'opt-1',
        text: '2:00 PM - Catch opening acts',
        voteCount: 5,
        voters: ['user-1', 'user-2', 'user-3', 'user-4', 'user-5'],
      },
      {
        id: 'opt-2',
        text: '4:00 PM - Mid-afternoon',
        voteCount: 11,
        voters: [
          'user-6',
          'user-7',
  ...
  // Trip 6: Johnson Family Summer Vacay
  {
    ...
    options: [
      {
        id: 'opt-1',
        text: 'Mountain View Steakhouse',
        voteCount: 6,
        voters: ['user-1', 'user-2', 'user-3', 'user-4', 'user-5', 'user-6'],
      },
      {
        id: 'opt-2',
        text: 'Italian Family Style',
        voteCount: 9,
        voters: [
          'user-7',
          'user-8',
      ...
      },
      {
        ...
        text: 'Asian Fusion',
        voteCount: 3,
        voters: ['user-16', 'user-17', 'user-18'],
      },
    ],
    status: 'active' as const,
    total_votes: 18,
  ...
  },
  {
    ...
    options: [
      {
        id: 'opt-1',
        text: '7:00 AM - Beat the heat',
        voteCount: 7,
        voters: ['user-1', 'user-2', 'user-3', 'user-4', 'user-5', 'user-6', 'user-7'],
      },
      {
        id: 'opt-2',
        text: '9:00 AM - After breakfast',
        voteCount: 8,
        voters: [
          'user-8',
          'user-9',
  ...
  // Trip 7: Fantasy Football Golf Outing
  {
    ...
    options: [
      ...
      {
        id: 'opt-3',
        text: 'Mexican Cantina',
        voteCount: 3,
        voters: ['user-14', 'user-15', 'user-16'],
      },
    ],
    status: 'active' as const,
    total_votes: 16,
  ...
  },
  {
    ...
    options: [
      {
        id: 'opt-1',
        text: '7:30 AM - Early birds',
        voteCount: 4,
        voters: ['user-1', 'user-2', 'user-3', 'user-4'],
      },
      {
        id: 'opt-2',
        text: '9:00 AM - Mid-morning',
        voteCount: 10,
        voters: [
          'user-5',
          'user-6',
  ...
  // Trip 8: Tulum Wellness Retreat
  {
    ...
    options: [
      ...
      {
        id: 'opt-2',
        text: 'Juice Bar & Smoothies',
        voteCount: 6,
        voters: ['user-13', 'user-14', 'user-15', 'user-16', 'user-17', 'user-18'],
      },
      {
        id: 'opt-3',
        text: 'Raw Food Kitchen',
        voteCount: 4,
        voters: ['user-19', 'user-20', 'user-21', 'user-22'],
      },
    ],
    status: 'active' as const,
    total_votes: 22,
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        text: '10:00 AM - Mid-morning',
        voteCount: 3,
        voters: ['user-20', 'user-21', 'user-22'],
      },
    ],
    status: 'active' as const,
    total_votes: 22,
  ...
  // Trip 9: Newly Divorced Wine-Tasting Getaway
  {
    ...
    options: [
      ...
      },
      {
        ...
        text: 'Bistro Jeanty',
        voteCount: 5,
        voters: ['user-8', 'user-9', 'user-10', 'user-11', 'user-12'],
      },
      {
        id: 'opt-3',
        text: 'Farmstead at Long Meadow',
        voteCount: 3,
        voters: ['user-13', 'user-14', 'user-15'],
      },
    ],
  ...
  },
  {
    ...
    options: [
      {
        id: 'opt-1',
        text: '11:00 AM - Morning tour',
        voteCount: 6,
        voters: ['user-1', 'user-2', 'user-3', 'user-4', 'user-5', 'user-6'],
      },
      {
        id: 'opt-2',
        text: '2:00 PM - Afternoon session',
        voteCount: 8,
        voters: [
          'user-7',
          'user-8',
  ...
  // Trip 10: Corporate Holiday Ski Trip ? Aspen
  {
    ...
    options: [
      ...
      },
      {
        ...
        voteCount: 5,
        voters: ['user-26', 'user-27', 'user-28', 'user-29', 'user-30'],
      },
    ],
    status: 'active' as const,
    total_votes: 30,
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: 'opt-3',
        text: '4:00 PM - Late afternoon',
        voteCount: 4,
        voters: ['user-27', 'user-28', 'user-29', 'user-30'],
      },
    ],
    status: 'active' as const,
    total_votes: 30,
  ...
  // Trip 11: Disney Cruise Family Vacation
  {
    ...
    options: [
      ...
      },
      {
        ...
        text: 'Buffet on Deck',
        voteCount: 5,
        voters: ['user-11', 'user-12', 'user-13', 'user-14', 'user-15'],
      },
      {
        id: 'opt-3',
        text: "Animator's Palate",
        voteCount: 7,
        voters: ['user-16', 'user-17', 'user-18', 'user-19', 'user-20', 'user-21', 'user-22'],
      },
    ],
    status: 'active' as const,
    total_votes: 22,
  ...
  // Trip 12: Yellowstone Hiking Adventure
  {
    ...
    options: [
      {
        id: 'opt-1',
        text: 'Old Faithful Inn Dining',
        voteCount: 7,
        voters: ['user-1', 'user-2', 'user-3', 'user-4', 'user-5', 'user-6', 'user-7'],
      },
      {
        id: 'opt-2',
        text: 'Canyon Lodge Eatery',
        voteCount: 5,
        voters: ['user-8', 'user-9', 'user-10', 'user-11', 'user-12'],
      },
      {
        id: 'opt-3',
        text: 'Lake Hotel Dining Room',
        voteCount: 3,
        voters: ['user-13', 'user-14', 'user-15'],
      },
    ],
  ...
  },
  {
    ...
    options: [
      {
        id: 'opt-1',
        text: '6:00 AM - Sunrise hike',
        voteCount: 6,
        voters: ['user-1', 'user-2', 'user-3', 'user-4', 'user-5', 'user-6'],
      },
      {
        id: 'opt-2',
        text: '8:00 AM - Morning start',
        voteCount: 8,
        voters: [
          'user-7',
          'user-8',
  ...
  // Pro Trip 1: Lakers Road Trip
  {
    ...
    options: [
      ...
      },
      {
        ...
        text: 'BOA Steakhouse',
        voteCount: 6,
        voters: ['user-9', 'user-10', 'user-11', 'user-12', 'user-13', 'user-14'],
      },
      {
        id: 'opt-3',
        text: "Craig's West Hollywood",
        voteCount: 4,
        voters: ['user-15', 'user-16', 'user-17', 'user-18'],
      },
    ],
    status: 'active' as const,
    total_votes: 18,
  ...
  // Pro Trip 2: Beyoncé Cowboy Carter Tour
  {
    ...
    options: [
      ...
      },
      {
        ...
        text: 'Uchi Dallas',
        voteCount: 5,
        voters: ['user-17', 'user-18', 'user-19', 'user-20', 'user-21'],
      },
    ],
    status: 'active' as const,
    total_votes: 21,
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        text: '7:00 PM',
        voteCount: 4,
        voters: ['user-18', 'user-19', 'user-20', 'user-21'],
      },
    ],
    status: 'active' as const,
    total_votes: 21,
  ...
  // Pro Trip 4: Paul George Elite AAU Nationals
  {
    ...
    options: [
      ...
      },
      {
        ...
        text: 'The Capital Grille',
        voteCount: 7,
        voters: ['user-10', 'user-11', 'user-12', 'user-13', 'user-14', 'user-15', 'user-16'],
      },
      {
        id: 'opt-3',
        text: 'Hard Rock Cafe',
  ...
  // Pro Trip 5: OSU vs Notre Dame 2025
  {
    ...
    options: [
      ...
      },
      {
        ...
        text: "Hind's Plaza",
        voteCount: 7,
        voters: ['user-11', 'user-12', 'user-13', 'user-14', 'user-15', 'user-16', 'user-17'],
      },
      {
        id: 'opt-3',
        text: 'Mirror Lake',
        voteCount: 5,
        voters: ['user-18', 'user-19', 'user-20', 'user-21', 'user-22'],
      },
    ],
    status: 'active' as const,
    total_votes: 22,
  ...
  // Pro Trip 6: UNC Men's Lacrosse 2025
  {
    ...
    options: [
      {
        id: 'opt-1',
        text: "Sutton's Drug Store",
        voteCount: 8,
        voters: ['user-1', 'user-2', 'user-3', 'user-4', 'user-5', 'user-6', 'user-7', 'user-8'],
      },
      {
        id: 'opt-2',
        text: 'Kipos Greek Taverna',
        voteCount: 6,
        voters: ['user-9', 'user-10', 'user-11', 'user-12', 'user-13', 'user-14'],
      },
      {
        id: 'opt-3',
        text: "Al's Burger Shack",
        voteCount: 4,
        voters: ['user-15', 'user-16', 'user-17', 'user-18'],
      },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        text: '8:00 PM',
        voteCount: 5,
        voters: ['user-20', 'user-21', 'user-22', 'user-23', 'user-24'],
      },
    ],
    status: 'active' as const,
    total_votes: 24,
  ...
  // Pro Trip 9: Tesla Cybertruck Roadshow
  {
    ...
    options: [
      ...
      {
        id: 'opt-3',
        text: 'Hawthorne Design Studio',
        voteCount: 6,
        voters: ['user-20', 'user-21', 'user-22', 'user-23', 'user-24', 'user-25'],
      },
    ],
    status: 'active' as const,
    total_votes: 25,
  ...
  // Pro Trip 10: Post Malone & Jelly Roll Tour
  {
    ...
    options: [
      ...
      {
        id: 'opt-3',
        text: 'The Southern Steak & Oyster',
        voteCount: 6,
        voters: ['user-17', 'user-18', 'user-19', 'user-20', 'user-21', 'user-22'],
      },
    ],
    status: 'active' as const,
    total_votes: 22,
  ...
  // Event Trip 1: SXSW 2025
  {
    ...
    options: [
      ...
      {
        id: 'opt-3',
        text: 'Convention Center Plaza',
        voteCount: 6,
        voters: ['user-19', 'user-20', 'user-21', 'user-22', 'user-23', 'user-24'],
      },
    ],
    status: 'active' as const,
    total_votes: 24,
  ...
  // Event Trip 2: World Economic Forum 2025
  {
    ...
    options: [
      {
        id: 'opt-1',
        text: 'Restaurant Cantinetta Antinori',
        voteCount: 12,
        voters: [
          'user-1',
          'user-2',
      ...
      {
        id: 'opt-2',
        text: 'Chesa Grischuna',
        voteCount: 7,
        voters: ['user-13', 'user-14', 'user-15', 'user-16', 'user-17', 'user-18', 'user-19'],
      },
      {
        id: 'opt-3',
        text: 'Kaffee Klatsch',
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        text: '9:00 AM',
        voteCount: 4,
        voters: ['user-21', 'user-22', 'user-23', 'user-24'],
      },
    ],
    status: 'active' as const,
    total_votes: 24,
  ...
  // Event Trip 3: Money20/20 Las Vegas 2025
  {
    ...
    options: [
      ...
      {
        id: 'opt-3',
        text: 'Catch Las Vegas',
        voteCount: 6,
        voters: ['user-21', 'user-22', 'user-23', 'user-24', 'user-25', 'user-26'],
      },
    ],
    status: 'active' as const,
    total_votes: 26,
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        text: '11:00 AM',
        voteCount: 4,
        voters: ['user-23', 'user-24', 'user-25', 'user-26'],
      },
    ],
    status: 'active' as const,
    total_votes: 26,
  ...
  // Event Trip 6: Invest Fest 2025
  {
    ...
    options: [
      ...
      {
        id: 'opt-2',
        text: 'Mercedes-Benz Stadium Plaza',
        voteCount: 9,
        voters: [
          'user-11',
          'user-12',
      ...
      {
        id: 'opt-3',
        text: 'Underground Atlanta',
        voteCount: 7,
        voters: ['user-20', 'user-21', 'user-22', 'user-23', 'user-24', 'user-25', 'user-26'],
      },
    ],
    status: 'active' as const,
    total_votes: 26,
  ...
  // Event Trip 7: The 67th Grammy Awards
  {
    ...
    options: [
      ...
      },
      {
        ...
        text: 'The Ivy',
        voteCount: 6,
        voters: ['user-18', 'user-19', 'user-20', 'user-21', 'user-22', 'user-23'],
      },
    ],
    status: 'active' as const,
    total_votes: 23,
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        text: '6:00 PM',
        voteCount: 4,
        voters: ['user-20', 'user-21', 'user-22', 'user-23'],
      },
    ],
    status: 'active' as const,
    total_votes: 23,
