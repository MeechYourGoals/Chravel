            ...
            >
              {citation.distanceFromBasecamp && (
                <span className="flex items-center gap-1">
                  ...
                  {citation.distanceFromBasecamp.value.toFixed(1)}{' '}
                  {citation.distanceFromBasecamp.unit} away
                </span>
              )}
              {citation.placeType && <span className="capitalize">• {citation.placeType}</span>}
            </div>
          )}
