...
export const ProTripCard = ({
  ...
  return (
    <div
      data-testid={`pro-trip-card-${tripIdStr}`}
    ...
    >
      ...
      <div className="p-4 md:p-6">
        ...
        <div className="grid grid-cols-2 gap-2 md:gap-3">
          ...
          <Button
            data-testid={`pro-trip-card-recap-${tripIdStr}`}
          ...
          <Button
            data-testid={`pro-trip-card-invite-${tripIdStr}`}
          ...
          <Button
            data-testid={`pro-trip-card-view-${tripIdStr}`}
          ...
          <Button
            data-testid={`pro-trip-card-share-${tripIdStr}`}
