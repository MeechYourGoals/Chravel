...
const MOCK_USERS = [
  { id: 'c0000000-demo-0000-0000-000000000001', first: 'Sarah', last: 'Chen', display: 'Sarah Chen', email: 'sarah.chen@mock.chravel.app' },
  { id: 'c0000000-demo-0000-0000-000000000002', first: 'Jordan', last: 'Alvarez', display: 'Jordan Alvarez', email: 'jordan.alvarez@mock.chravel.app' },
  { id: 'c0000000-demo-0000-0000-000000000003', first: 'Maya', last: 'Patel', display: 'Maya Patel', email: 'maya.patel@mock.chravel.app' },
  { id: 'c0000000-demo-0000-0000-000000000004', first: 'Marcus', last: 'Lee', display: 'Marcus Lee', email: 'marcus.lee@mock.chravel.app' },
  { id: 'c0000000-demo-0000-0000-000000000005', first: 'Nina', last: 'Brooks', display: 'Nina Brooks', email: 'nina.brooks@mock.chravel.app' },
  { id: 'c0000000-demo-0000-0000-000000000006', first: 'Priya', last: 'Shah', display: 'Priya Shah', email: 'priya.shah@mock.chravel.app' },
  { id: 'c0000000-demo-0000-0000-000000000007', first: 'Ethan', last: 'Walker', display: 'Ethan Walker', email: 'ethan.walker@mock.chravel.app' },
  { id: 'c0000000-demo-0000-0000-000000000008', first: 'Olivia', last: 'Carter', display: 'Olivia Carter', email: 'olivia.carter@mock.chravel.app' },
];
...
type PayDef = { amount: number; desc: string; creator: number; currency?: string; participants: number[] };
...
const TRIP_CONFIGS: Record<string, TripConfig> = {
  ...
  'carlton-iceland-2026': {
    ...
    messages: [
      { a: -1, c: 'Trip is BOOKED. Iceland, Jan 8-14. Northern lights, hot springs, the works 🇮🇸', d: -21 },
      ...
      { a: -1, c: 'Hotel Rangá confirmed — they have a hot tub with direct aurora views 🌌', d: -18 },
      ...
      { a: -1, c: 'Golden Circle day trip confirmed — Gullfoss, Geysir, Thingvellir. Driver picks us up 9am', d: -12 },
      { a: 2, c: 'Can we add the Silfra snorkeling? The tectonic plate rift is insane', d: -12 },
      { a: -1, c: 'Added it! Jan 9th morning slot', d: -12 },
      { a: -1, c: 'created a poll: "Ice cave tour — morning or afternoon?"', d: -10, t: 'system', se: 'poll_created' },
      { a: 0, c: 'Morning for sure, the light is better for photos', d: -10 },
      { a: 2, c: 'updated the Trip\'s Basecamp to Hotel Rangá', d: -9, t: 'system', se: 'trip_base_camp_updated' },
      { a: 1, c: 'Just bought crampons and hand warmers. I\'m ready for -15°C', d: -8 },
      { a: 2, c: 'Don\'t forget to download the aurora forecast app — "My Aurora Forecast"', d: -7 },
      { a: -1, c: 'Jeep tour for Northern Lights booked for the 10th. Everyone ready by 8pm', d: -5 },
      { a: 0, c: 'What\'s the restaurant situation? I want to try hákarl (fermented shark)', d: -4 },
      { a: 2, c: 'Grillið is supposed to be amazing for Icelandic lamb. Reserving for the 12th', d: -4 },
    ...
    polls: [
      { question: 'Ice cave tour — morning or afternoon?', options: ['Morning (better light)', 'Afternoon (sleep in)'], creator: -1 },
    ],
    payments: [
  ...
  'carlton-ibiza-2026': {
    ...
    messages: [
      ...
      { a: -1, c: 'Lio Ibiza for the birthday dinner. Cabaret + dinner + party all in one', d: -20 },
      ...
      { a: -1, c: 'created a poll: "Beach club day — Nikki Beach or Blue Marlin?"', d: -15, t: 'system', se: 'poll_created' },
      ...
      { a: 2, c: 'I\'m bringing a birthday cake from Can Caus bakery. Any dietary restrictions?', d: -10 },
      { a: 6, c: 'Just make sure there\'s enough for seconds 🎂', d: -10 },
      { a: -1, c: 'added a payment: Villa Can Furnet (4 nights)', d: -8, t: 'system', se: 'payment_recorded' },
    ...
    polls: [
      { question: 'Beach club day — Nikki Beach or Blue Marlin?', options: ['Nikki Beach', 'Blue Marlin Ibiza'], creator: -1 },
    ],
    payments: [
      { amount: 2400, desc: 'Villa Can Furnet (4 nights)', creator: -1, participants: [-1, 1, 4, 6, 2] },
      { amount: 340, desc: 'Birthday dinner at Lio', creator: 4, participants: [-1, 1, 4, 6, 2] },
      { amount: 85, desc: 'Café del Mar drinks & snacks', creator: 6, participants: [-1, 1, 4, 6, 2] },
    ],
  },
  ...
  'carlton-tokyo-2025': {
    ...
    messages: [
      ...
      { a: -1, c: 'created a poll: "Shibuya Crossing vs Akihabara for first afternoon?"', d: -18, t: 'system', se: 'poll_created' },
      ...
      { a: -1, c: 'updated the Trip\'s Basecamp', d: -15, t: 'system', se: 'trip_base_camp_updated' },
      { a: 2, c: 'Day 3 plan: Teamlab Borderless in the morning, then Harajuku street food', d: -12 },
    ...
    polls: [
      { question: 'First afternoon — Shibuya or Akihabara?', options: ['Shibuya Crossing', 'Akihabara', 'Harajuku'], creator: -1 },
    ],
    payments: [
      { amount: 120, desc: 'Suica transit cards (4 loaded)', creator: -1, participants: [-1, 2, 0, 1] },
      { amount: 280, desc: 'Hakone day trip + private onsen', creator: 0, participants: [-1, 2, 0, 1] },
  ...
  'carlton-amalfi-2026': {
    ...
    messages: [
      { a: -1, c: 'Amalfi Coast, June 20-27. Positano, Ravello, limoncello on the cliffs 🍋🇮🇹', d: -25 },
      ...
      { a: -1, c: 'created a poll: "Ravello concert — classical or jazz night?"', d: -15, t: 'system', se: 'poll_created' },
      { a: 2, c: 'Classical at Villa Rufolo. The sunset over the stage is iconic', d: -15 },
      { a: 4, c: 'Adding Da Adolfo beach restaurant to the list. You take a boat there 🚤', d: -12 },
      { a: 0, c: 'Dinner at La Sponda in Positano — 400 candles light the restaurant', d: -10 },
      { a: -1, c: 'Booked it. June 24th, 8pm', d: -10 },
      { a: 2, c: 'I\'m going to learn to make limoncello from a local. Anyone want to join?', d: -8 },
    ...
    polls: [
      { question: 'Ravello concert — classical or jazz night?', options: ['Classical at Villa Rufolo', 'Jazz evening'], creator: -1 },
    ],
    payments: [
      { amount: 480, desc: 'Private boat charter (full day)', creator: -1, participants: [-1, 0, 4, 2] },
  ...
  'carlton-bali-2026': {
    ...
    messages: [
      ...
      { a: -1, c: 'created a poll: "Day trip — Ubud monkey forest or Nusa Penida island?"', d: -15, t: 'system', se: 'poll_created' },
      ...
      { a: 6, c: 'Found an amazing villa with a private pool in Canggu for overflow nights', d: -12 },
    ...
    polls: [
      { question: 'Day trip — Ubud monkey forest or Nusa Penida?', options: ['Ubud Monkey Forest', 'Nusa Penida Island', 'Both!'], creator: -1 },
    ],
    payments: [
  ...
  'carlton-greek-islands-2026': {
    ...
    messages: [
      ...
      { a: -1, c: 'Canaves Oia Suites in Santorini is locked. Cave suite with caldera views', d: -20 },
      { a: 1, c: 'What about Mykonos accommodations?', d: -19 },
      { a: 4, c: 'I found a villa near Psarou Beach. Pool + ocean views', d: -18 },
      { a: -1, c: 'created a poll: "Catamaran sunset cruise — Santorini or Mykonos?"', d: -16, t: 'system', se: 'poll_created' },
      { a: 0, c: 'Santorini catamaran with the caldera backdrop. No question', d: -16 },
      { a: 2, c: 'Paros is supposed to be the food island. Naoussa village is all seafood tavernas', d: -14 },
      ...
      { a: 2, c: 'The octopus at that taverna in Naoussa was the best thing I\'ve eaten all year', d: 7 },
    ...
    polls: [
      { question: 'Catamaran sunset cruise — Santorini or Mykonos?', options: ['Santorini (caldera views)', 'Mykonos (party vibes)'], creator: -1 },
    ],
    payments: [
      { amount: 360, desc: 'Inter-island ferry tickets (3 ferries)', creator: 1, participants: [-1, 0, 1, 4, 2] },
  ...
  'carlton-mexico-city-2025': {
    ...
    messages: [
      { a: -1, c: 'CDMX Art Weekend, Nov 14-17. Gallery openings, street art, tacos al pastor 🇲🇽', d: -20 },
  ...
  'carlton-miami-f1-consumer': {
    ...
    messages: [
      ...
      { a: -1, c: 'created a poll: "Friday night — LIV or E11EVEN?"', d: -18, t: 'system', se: 'poll_created' },
    ...
    polls: [
      { question: 'Friday night — LIV or E11EVEN?', options: ['LIV Miami', 'E11EVEN', 'Both (we don\'t sleep)'], creator: -1 },
    ],
    payments: [
  ...
  'carlton-nola-jazz-2025': {
    ...
    messages: [
      { a: -1, c: 'New Orleans Jazz Weekend Oct 17-20. Frenchmen St, beignets, live jazz 🎺', d: -22 },
      ...
      { a: 6, c: 'Spotted Cat on Frenchmen St is where the real jazz happens. No cover, just vibes', d: -12 },
      { a: -1, c: 'created a poll: "Swamp tour or cemetery tour?"', d: -10, t: 'system', se: 'poll_created' },
  ...
  'carlton-nba-summer-2025': {
    ...
    messages: [
      { a: -1, c: 'NBA Summer League Vegas Jul 11-15. Scouting rookies and pool parties 🏀', d: -20 },
  ...
  'carlton-toronto-2026': {
    ...
    messages: [
      { a: -1, c: 'Toronto Food & Music Weekend Apr 10-14. Kensington Market, CN Tower, OVO Fest vibes 🇨🇦', d: -20 },
      ...
      { a: 2, c: 'Kensington Market food crawl is happening Day 1. Jerk chicken, empanadas, everything', d: -12 },
      { a: 6, c: 'There\'s a jazz club in the Distillery District that\'s incredible', d: -10 },
      { a: -1, c: 'created a poll: "Raptors game or Blue Jays game?"', d: -8, t: 'system', se: 'poll_created' },
    ...
    polls: [
      { question: 'Raptors game or Blue Jays game?', options: ['Raptors (basketball)', 'Blue Jays (baseball)'], creator: -1 },
    ],
    payments: [
  ...
  'carlton-chappelle-chicago': {
    ...
    messages: [
      { a: -1, c: 'Chappelle Chicago stop confirmed. Sep 18-21. Load-in, soundcheck, show night 🎤', d: -18 },
  ...
  'carlton-creator-conf-nyc': {
    ...
    messages: [
      { a: -1, c: 'Creator Economy Conference NYC, Aug 20-23. Keynote, brand workshops, after-party 📱', d: -22 },
      ...
      { a: -1, c: 'created a poll: "After-party DJ — house or hip-hop set?"', d: -6, t: 'system', se: 'poll_created' },
    ...
    payments: [
      ...
      { amount: 180, desc: 'After-party venue contribution', creator: 4, participants: [-1, 5, 4, 0] },
    ],
  },
  ...
  'carlton-dj-tour-berlin': {
    ...
    messages: [
      ...
      { a: 4, c: 'Content crew arriving Thursday. Need backstage access for all three venues', d: -6 },
    ...
    payments: [
      { amount: 400, desc: 'Studio session booking (6 hrs)', creator: 6, participants: [-1, 6, 4, 3] },
      { amount: 150, desc: 'Guest list coordination + VIP', creator: 3, participants: [-1, 6, 4, 3] },
    ],
  },
  ...
  'carlton-fashion-paris': {
    ...
    messages: [
      { a: -1, c: 'Paris Fashion Week Coverage Jun 28 - Jul 3. Jacquemus, LV backstage, Palais de Tokyo 🇫🇷', d: -22 },
      ...
      { a: 2, c: 'Content shoot locations scouted — Palais de Tokyo and Tuileries Gardens', d: -14 },
  ...
  'carlton-film-vancouver': {
    ...
    messages: [
      { a: -1, c: 'Vancouver film shoot Apr 22-27. Scouting, crew coordination, post-production 🎬', d: -20 },
    ...
    payments: [
      { amount: 1200, desc: 'Equipment rental (Arri Alexa + grip)', creator: 3, participants: [-1, 7, 3, 0] },
  ...
  'carlton-founder-tahoe': {
    ...
    messages: [
      { a: -1, c: 'Venture Founder Retreat at Lake Tahoe Jul 10-14. Fireside chats, pitch sessions, networking 🏔️', d: -25 },
      { a: 5, c: 'The VC lineup is incredible this year. Three Sequoia partners confirmed', d: -25 },
      ...
      { a: 5, c: 'I\'m workshopping my Series A pitch. Can someone give feedback Thursday night?', d: -15 },
      { a: 0, c: 'Absolutely. Let\'s do a fireside pitch review at 8pm', d: -15 },
      { a: -1, c: 'created a poll: "Keynote topic — AI moats or marketplace dynamics?"', d: -12, t: 'system', se: 'poll_created' },
      ...
      { a: 0, c: 'Three warm intros made. This retreat is the highest ROI event of the year', d: 3 },
    ],
    tasks: [
    ...
    payments: [
      { amount: 800, desc: 'Retreat registration (4 passes)', creator: -1, participants: [-1, 5, 3, 0] },
      { amount: 240, desc: 'Boat rental for networking session', creator: 3, participants: [-1, 5, 3, 0] },
    ],
  },
  ...
  'carlton-music-fest-la': {
    ...
    messages: [
      { a: -1, c: 'LA Music Festival Production May 15-19. Stage management, sound, artist logistics 🎵', d: -20 },
      ...
      { a: 6, c: 'updated the Trip\'s Basecamp to THE LINE LA', d: -4, t: 'system', se: 'trip_base_camp_updated' },
    ...
    payments: [
      { amount: 950, desc: 'Crew accommodations (4 rooms, 3 nights)', creator: -1, participants: [-1, 6, 3, 7] },
  ...
  'carlton-nba-media-vegas': {
    ...
    messages: [
      { a: -1, c: 'NBA Summer League Media Trip Jul 12-16. Press credentials, courtside, interviews 📸🏀', d: -20 },
  ...
  'carlton-podcast-austin': {
    ...
    messages: [
      { a: -1, c: 'Podcast Creator Summit Austin Oct 3-6. Live recordings, meetups, brand deals 🎙️', d: -22 },
      { a: 5, c: 'Three live recordings scheduled! This is going to be huge', d: -22 },
      { a: 6, c: 'joined the trip', d: -20, t: 'system', se: 'member_joined' },
      { a: 0, c: 'joined the trip', d: -20, t: 'system', se: 'member_joined' },
      { a: 5, c: 'joined the trip', d: -20, t: 'system', se: 'member_joined' },
      { a: 0, c: 'South Congress Hotel is perfect. That lobby is great for impromptu meetings', d: -19 },
  ...
  'carlton-sports-agent-miami': {
    ...
    messages: [
      { a: -1, c: 'Sports Agent Client Meeting Miami Jan 22-25. Contract negotiations, dinners, Heat game 🏀💼', d: -18 },
  ...
  'carlton-event-art-basel': {
    ...
    messages: [
      { a: -1, c: 'Art Basel Miami Dec 3-7. Gallery previews, Wynwood installations, collector dinners 🎨', d: -22 },
      ...
      { a: -1, c: 'created a poll: "Gallery crawl route — Wynwood or Design District first?"', d: -10, t: 'system', se: 'poll_created' },
    ...
    polls: [
      { question: 'Gallery crawl route — Wynwood or Design District first?', options: ['Wynwood (murals + galleries)', 'Design District (high-end)'], creator: -1 },
    ],
    payments: [
  ...
  'carlton-event-cannes': {
    ...
    messages: [
      { a: -1, c: 'Cannes Film Festival May 19-25. Red carpets, yacht parties, filmmaker networking 🎬🇫🇷', d: -25 },
    ...
    polls: [
      { question: 'Which premiere to prioritize?', options: ['Opening night gala', 'Palme d\'Or contender', 'Independent film showcase'], creator: 7 },
    ],
    payments: [
  ...
  'carlton-event-jfl-montreal': {
    ...
    messages: [
      { a: -1, c: 'Just For Laughs Montreal Jul 15-20. Comedy showcases, gala tapings, late-night sets 😂🇨🇦', d: -20 },
      { a: 7, c: 'JFL is the comedy Super Bowl. The lineup this year is stacked', d: -20 },
      { a: 6, c: 'joined the trip', d: -18, t: 'system', se: 'member_joined' },
      { a: 1, c: 'joined the trip', d: -18, t: 'system', se: 'member_joined' },
      { a: 7, c: 'joined the trip', d: -18, t: 'system', se: 'member_joined' },
      { a: 1, c: 'Hotel Nelligan in Old Montreal. Cobblestone streets, amazing restaurants', d: -17 },
      ...
      { a: 7, c: 'Late-night showcase at Club Soda was the highlight. Raw, unfiltered comedy', d: 1 },
    ...
    payments: [
      { amount: 320, desc: 'Festival all-access passes (4x)', creator: -1, participants: [-1, 7, 6, 1] },
  ...
  'carlton-event-miami-f1': {
    ...
    messages: [
      { a: -1, c: 'Miami F1 Grand Prix Event May 1-4. Paddock access, fan zones, after-parties 🏎️', d: -22 },
      ...
      { a: -1, c: 'Fan zone activation plan finalized. Interactive F1 sim, merch, photo ops', d: -12 },
  ...
  'carlton-event-monaco-gp': {
    ...
    messages: [
      { a: -1, c: 'Monaco Grand Prix May 22-26. Yacht viewing, Casino Square, the circuit 🏎️🇲🇨', d: -25 },
      { a: 4, c: 'Monaco is the most glamorous weekend in motorsport. I\'m already planning outfits', d: -25 },
      { a: 3, c: 'joined the trip', d: -22, t: 'system', se: 'member_joined' },
    ...
    polls: [
      { question: 'Friday evening — Casino night or harbor dinner?', options: ['Monte Carlo Casino', 'Harbor-side dinner', 'Both!'], creator: -1 },
    ],
    payments: [
  ...
  'carlton-event-sundance': {
    ...
    messages: [
      { a: -1, c: 'Sundance Film Festival Jan 22-28. Indie premieres, Q&As, après-ski 🎬🏔️', d: -22 },
      ...
      { a: -1, c: 'created a poll: "Which premiere on opening night?"', d: -8, t: 'system', se: 'poll_created' },
    ...
    polls: [
      { question: 'Opening night premiere — drama or documentary?', options: ['Drama premiere', 'Documentary premiere', 'Split up and compare notes'], creator: -1 },
    ],
    payments: [
      { amount: 450, desc: 'Festival passes (4x)', creator: -1, participants: [-1, 7, 5, 0] },
      { amount: 180, desc: 'Ski passes for off-screening days', creator: 0, participants: [-1, 7, 5, 0] },
    ],
  },
  ...
  'carlton-event-super-bowl': {
    collaborators: [3, 1, 6], // Marcus, Jordan, Ethan
    messages: [
      { a: -1, c: 'Super Bowl 2027 in New Orleans! Feb 12-15. Tailgate, concerts, best seats in the house 🏈', d: -30 },
      ...
      { a: 6, c: 'Pre-game concerts on Bourbon Street all week. The city is going to be electric', d: -25 },
      { a: 3, c: 'Tickets confirmed. 50 yard line, lower bowl. LET\'S GO', d: -20 },
      { a: -1, c: 'Tailgate party organized for Sunday morning. BBQ and cocktails before the game', d: -15 },
      { a: -1, c: 'created a poll: "Tailgate food — BBQ or seafood boil?"', d: -12, t: 'system', se: 'poll_created' },
    ...
    polls: [
      { question: 'Tailgate food — BBQ or seafood boil?', options: ['Classic BBQ spread', 'NOLA seafood boil', 'Both!'], creator: -1 },
    ],
    payments: [
      { amount: 2800, desc: 'Super Bowl tickets (4x, lower bowl)', creator: 3, participants: [-1, 3, 1, 6] },
  ...
  'carlton-event-sxsw': {
    ...
    messages: [
      { a: -1, c: 'SXSW Austin 2026 Mar 6-15. The full experience — music, interactive, film 🤘🎬', d: -28 },
      ...
      { a: -1, c: 'created a poll: "Late night — 6th Street or Rainey Street?"', d: -8, t: 'system', se: 'poll_created' },
    ...
    payments: [
      { amount: 500, desc: 'SXSW Platinum passes (5x)', creator: -1, participants: [-1, 5, 6, 7, 0] },
  ...
  for (const trip of trips) {
    ...
    for (let i = 0; i < config.messages.length; i++) {
      ...
      allMessages.push({
        ...
        payload: msg.se ? JSON.stringify({ actorName: authorName, seed_version: SEED_VERSION }) : null,
...
// ─── SEED PAYMENTS ───────────────────────────────────────────────────────────
async function seedPayments(supabase: any, trips: any[]): Promise<{ payments: number; splits: number }> {
  let paymentCount = 0;
  let splitCount = 0;
...
serve(async (req) => {
  ...
  try {
    ...
    if (!carltonTrips?.length) {
      return new Response(JSON.stringify({ error: 'No Carlton trips found' }), { status: 404, headers });
    }
    ...
    console.log(`[seed-carlton-social] Payments inserted: ${paymentResult.payments}, Splits: ${paymentResult.splits}`);
