  ...
  return (
    <div className="text-center py-16 px-4">
      ...
      <p className="text-gray-400 mb-8 max-w-md mx-auto">
        Stay organized! Create tasks to keep track of everything that needs to get done for this trip.
      </p>
      <Button
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto text-left">
        <div className="p-4 bg-white/5 rounded-lg border border-white/10">
          ...
          <p className="text-sm text-gray-400">Assign tasks to trip members and track completion in real-time</p>
        </div>
        <div className="p-4 bg-white/5 rounded-lg border border-white/10">
          <h4 className="font-semibold mb-2 text-white">Set Deadlines</h4>
          <p className="text-sm text-gray-400">Add due dates to ensure everything gets done on time</p>
        </div>
        <div className="p-4 bg-white/5 rounded-lg border border-white/10">
          <h4 className="font-semibold mb-2 text-white">Stay Organized</h4>
          <p className="text-sm text-gray-400">Filter by status, assignee, and date to stay on top of tasks</p>
        </div>
      </div>
    </div>
  );
