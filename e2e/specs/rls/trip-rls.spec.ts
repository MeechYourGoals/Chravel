...
test.describe('Edge Function Permission Tests', () => {
  ...
  test('RLS-TRIP-006: Creator leaves - trip persists, remaining member retains access', async ({
    createTestUser,
    createTestTrip,
    addTripMember,
    getClientAsUser,
    ...
    // Remaining member retains access
    const clientMember = await getClientAsUser(member);
    ...
    // Trip record still exists (not deleted)
    ...
    // Member's membership is still active
