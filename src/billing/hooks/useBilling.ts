...
import { getBillingProvider, getPlatform, canUseWebCheckout, requiresIAPForTier } from '../providers';
...
export function useBilling(): UseBillingReturn {
   ...
   */
  const canUseFeature = useCallback((feature: FeatureName, context?: FeatureContext): boolean => {
   ...
   */
  const purchase = useCallback(async (request: PurchaseRequest): Promise<PurchaseResult> => {
