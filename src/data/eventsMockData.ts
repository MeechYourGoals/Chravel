...
export const eventsMockData: Record<string, EventData> = {
  ...
  'netflix-joke-fest-2026': {
    ...
    description:
      'Multi-day comedy festival featuring stand-up, live podcasts, and exclusive Netflix specials across LA venues',
    ...
    participants: [
      { id: 1, name: 'Sarah Chen', avatar: getMockAvatar('Sarah Chen'), role: 'Festival Director' },
      {
        ...
        avatar: getMockAvatar('Marcus Rodriguez'),
      ...
      { id: 3, name: 'Jessica Kim', avatar: getMockAvatar('Jessica Kim'), role: 'Venue Manager' },
      {
        id: 4,
        name: 'David Thompson',
        avatar: getMockAvatar('David Thompson'),
    ...
    agenda: [
      ...
      {
        id: 'njf-a3',
        title: 'Closing Night Spectacular',
        start_time: '20:00',
        end_time: '23:30',
  ...
  'sxsw-2026': {
    ...
    participants: [
      ...
      },
      {
        id: 3,
        name: 'Jessica Kim',
        avatar: getMockAvatar('Jessica Kim'),
  ...
  'wef-2026': {
    ...
    participants: [
      {
        ...
        avatar: getMockAvatar('Dr. Elena Volkov'),
        role: 'Forum Director',
      },
      {
        id: 6,
        name: 'Ambassador Chen Wei',
        avatar: getMockAvatar('Ambassador Chen Wei'),
        role: 'Policy Advisor',
      },
      {
        id: 7,
        name: 'Maria Santos',
        avatar: getMockAvatar('Maria Santos'),
        role: 'Economics Lead',
      },
    ],
    itinerary: [
    ...
    agenda: [
      ...
      {
        id: 'wef-a3',
        title: 'Climate and Economy Panel',
        start_time: '14:00',
        end_time: '15:30',
        location: 'Forum Hall',
        speakers: ['Al Gore', 'Christine Lagarde'],
      },
    ],
    tasks: [
  ...
  'invest-fest-2026': {
    ...
    participants: [
      {
        ...
        avatar: getMockAvatar('Jamal Washington'),
        role: 'Finance Director',
      },
      {
        id: 16,
        name: 'Keisha Davis',
        avatar: getMockAvatar('Keisha Davis'),
        role: 'Community Lead',
      },
    ],
    itinerary: [
    ...
    tasks: [
      {
        id: 'if-t1',
        title: 'Pick up your badge and welcome kit at registration',
        description: 'Located in the main lobby, opens at 7:30 AM',
        sort_order: 0,
      },
      {
        id: 'if-t2',
        title: 'Complete the attendee survey for a chance to win prizes',
        sort_order: 1,
      },
  ...
  'money2020-2026': {
    ...
    participants: [
      {
        id: 8,
        name: 'Alex Rivera',
        avatar: getMockAvatar('Alex Rivera'),
    ...
    agenda: [
      ...
      {
        id: 'm20-a2',
        title: 'Future of Payments Keynote',
        start_time: '09:30',
        end_time: '11:00',
  ...
  'elan-steakhouse-opening-2026': {
    ...
    description:
      'Invitation-only grand opening celebration for Élan Steakhouse, a new luxury dining destination in Chicago. Guests enjoy chef-led tastings, signature cocktails, live jazz, and a first look at the space.',
    tags: ['Fine Dining', 'Steakhouse', 'Grand Opening', 'Chicago', 'Hospitality'],
    participants: [
      {
        id: 11,
        name: 'Chef Antoine Rousseau',
        avatar: getMockAvatar('Chef Antoine Rousseau'),
        role: 'Executive Chef',
      },
      {
        id: 12,
        name: 'Emily Carter',
        avatar: getMockAvatar('Emily Carter'),
        ...
        events: [
          {
            ...
            location: 'Élan Steakhouse Main Dining Room',
            time: '18:00',
          },
    ...
    agenda: [
      ...
      {
        id: 'elan-a2',
        title: 'Chef-Led Tasting Experience',
        start_time: '19:00',
        end_time: '21:00',
  ...
  'inbound-2026': {
    ...
    participants: [
      {
        id: 13,
        name: 'Maya Patel',
        avatar: getMockAvatar('Maya Patel'),
        role: 'Marketing Director',
      },
      {
        id: 14,
        name: 'Chris Johnson',
        avatar: getMockAvatar('Chris Johnson'),
        role: 'Sales Strategy',
      },
    ],
    itinerary: [
    ...
    agenda: [
      ...
      {
        id: 'inb-a2',
        title: 'Future of Marketing Keynote',
        start_time: '10:00',
        end_time: '11:30',
        location: 'Main Stage',
      },
    ...
    participants: [
      {
        ...
        avatar: getMockAvatar('Isabella Martinez'),
        role: 'Awards Producer',
      },
      {
        id: 18,
        name: 'Michael Torres',
        avatar: getMockAvatar('Michael Torres'),
        role: 'Music Director',
      },
    ],
    itinerary: [
    ...
    agenda: [
      {
        ...
        start_time: '17:00',
        end_time: '19:30',
        location: 'Crypto.com Arena Entrance',
      },
      {
        id: 'gr-a2',
  ...
  'yc-demo-day-2026': {
    ...
    participants: [
      { id: 19, name: 'Amanda Liu', avatar: getMockAvatar('Amanda Liu'), role: 'Program Director' },
      {
        id: 20,
        name: 'Kevin Brown',
        avatar: getMockAvatar('Kevin Brown'),
    ...
    agenda: [
      ...
      {
        id: 'yc-a2',
        title: 'Startup Presentations Day 1',
        start_time: '09:00',
        end_time: '17:00',
    ...
    participants: [
      {
        id: 21,
        name: 'Zoe Parker',
        avatar: getMockAvatar('Zoe Parker'),
        role: 'Creator Relations',
      },
      {
        id: 22,
        name: 'Tyler Johnson',
        avatar: getMockAvatar('Tyler Johnson'),
  ...
  'french-riviera-marathon-2026': {
    ...
    description:
      'The iconic French Riviera Marathon running along the Mediterranean coastline from Nice to Cannes. A globally recognized race welcoming elite athletes and amateur runners alike, ending with a festival-style finish on the Croisette.',
    ...
    participants: [
      { id: 25, name: 'Marc Dupont', avatar: getMockAvatar('Marc Dupont'), role: 'Race Director' },
      {
        id: 26,
        name: 'Sophie Laurent',
        avatar: getMockAvatar('Sophie Laurent'),
    ...
    itinerary: [
      {
        ...
        events: [
          {
            title: 'Race Check-in & Bib Pickup',
  ...
  'spotify-house-seoul-2026': {
    ...
    participants: [
      ...
      { id: 3, name: 'Min-ji Kim', avatar: getMockAvatar('Min-ji Kim'), role: 'Event Producer' },
      {
        id: 4,
        name: 'Alex Chen',
        avatar: getMockAvatar('Alex Chen'),
        role: 'Spotify Partnerships',
      },
    ],
    itinerary: [
      {
        ...
        events: [
          ...
          {
            title: 'Opening Performance & Brand Activation',
            location: 'Main Stage',
            time: '20:00',
          },
