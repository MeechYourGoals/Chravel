---
name: prd
description: Use when creating a new Product Requirements Document (PRD) for a feature. Triggers on "write a PRD", "create PRD", "plan feature", "new feature spec". Produces structured markdown with user stories, acceptance criteria, and technical approach.
---
